      ...
      >
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 rounded-full bg-brand-panel border border-brand-border flex items-center justify-center mb-4 overflow-hidden relative shadow-lg">
            ...
            />
            <div className="absolute inset-0 bg-brand-panel flex items-center justify-center text-brand-accent font-bold text-3xl hidden">
              S
            </div>
          </div>
              ...
              >
                ...
                {success && (
                  <motion.div 
                    initial={{ opacity: 0, scale: 0.95 }}
                    animate={{ opacity: 1, scale: 1 }}
                    className="p-3 rounded-xl bg-status-success/10 border border-status-success/20 text-status-success text-sm font-medium text-center flex items-center justify-center gap-2"
                  >
                ...
                {isResetSent ? (
                  <div className="flex flex-col items-center justify-center text-center py-4 space-y-4">
                    ...
                    <button
                      ...
                      className="w-full mt-4 py-2.5 px-4 bg-brand-panel hover:bg-brand-bg border border-brand-border text-brand-text rounded-xl font-medium transition-all focus:outline-none focus:ring-2 focus:ring-brand-accent cursor-pointer"
                    >
                      Back to Login
                    </button>
                  </div>
                  ...
                  <>
                    <button 
                      ...
                      className="absolute top-4 left-4 p-2 text-brand-text/50 hover:text-brand-text bg-brand-panel hover:bg-brand-bg border border-brand-border rounded-xl transition-colors cursor-pointer"
                      title="Back to login"
                    >
                      <ArrowLeft size={16} />
                    </button>
                    ...
                    {error && (
                      <div className="p-3 rounded-xl bg-status-danger/10 border border-status-danger/20 text-status-danger text-sm font-medium text-center">
                        {error}
                      </div>
                    )}
